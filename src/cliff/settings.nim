...
type
    CliffSettings* = object
        ...
        field_ver  *: proc (spf: seq[PositionedField], pal: Option[int]): Option[PositionedField]
        field_len1 *: proc (spf: seq[PositionedField], pal: Option[int]): PositionedField
        field_len2 *: proc (spf: seq[PositionedField], pal: Option[int]): Option[PositionedField]
        prepend_append_lengths *: proc (spf: seq[PositionedField]): (int, int)
        ## always determined last
        field_crc  *: proc (spf: seq[PositionedField], pal: Option[int]): Option[PositionedField]
